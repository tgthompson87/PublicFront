...
const Bomb = ({
  ...
  //flash cycle handler logic, link to count state in conditionals to forward cycleFlashVariants
  const [flashVariants, cycleFlashVariants] = useCycle(
    bombFlashVariant1,
    bombFlashVariant2,
    bombFlashVariant3,
    bombFlashVariant4
  ...
  useEffect(() => {
    if (count >= 14 && flashState === "none") {
      cycleFlashVariants();
      setFlashState("stage1");
    }
    if (count >= 17 && flashState === "stage1") {
      cycleFlashVariants();
      setFlashState("stage2");
    }
    if (count >= 19 && flashState === "stage2") {
      cycleFlashVariants();
      setFlashState("stage3");
    }
    if (count >= 21 && flashState === "stage3") {
      cycleFlashVariants();
      setFlashState("stage4");
    }
  }, [count, flashState, cycleFlashVariants]);

  //logic to handle count per turn so the bomb isn't passed without tapping
  const onTapHandler = () => {
    if (
      (bombHitsP1 > 0 && player1.computer === false) ||
      (bombHitsP2 > 0 && player2.computer === false)
    ) {
      cycleBombPositionC1();
      cycleBombPositionC2();
      setTurnSwap((prev) => !prev);
    }
  };
    ...
    <div style={styles.containerAll}>
      <div style={styles.displayScreen}>
        {player1.computer === true && (
          <motion.div
            initial={{ y: "-200vh", x: "-18vh", originX: 0.5, originY: 0.75 }}
            animate={bombPositionC1}
          >
            <motion.div
              initial={{ rotate: 0, originX: 0.7, originY: 0.7 }}
              animate={wiggle}
            >
              <motion.div
                initial={{ rotate: 0, originX: 0.7, originY: 0.7 }}
              ...
              >
                ...
                >
                  <g id="bomb 1" clipPath="url(#clip0)">
                    <motion.g
                      style={styles.bombClick}
                      onTap={onTapHandler}
                      id="whole bomb"
                    >
                      <g id="bomb">
                        <path
                          ...
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M1131.68 263.123L1106 270.459C1105.64 270.43 1104.73 270.475 1104.18 270.459C1080.3 269.748 1056.16 272.064 1031.73 277.799C983.455 289.121 937.276 316.52 897.823 362.173C850.867 343.903 806.594 346.84 791.437 372.262L776.761 397.023C626.098 365.968 465.624 430.782 382.401 570.359C277.285 746.644 335.429 974.248 511.714 1079.38C687.999 1184.49 915.603 1127.27 1020.73 950.978C1104.02 811.29 1085.04 639.555 985.878 521.773L1000.55 497.013C1014.38 473.845 1000.2 438.02 968.453 407.132C994.092 379.982 1021.08 365.331 1050.08 358.53C1066.87 354.588 1084.96 353.841 1103.27 354.858L1130.79 367.7L1135.37 347.522L1150.96 337.433L1134.45 312.673L1154.63 286.074L1133.53 282.406L1131.72 263.148L1131.68 263.123Z"
                          fill="#000000"
                          stroke="#000000"
                          strokeWidth="37.2691"
                        />
                        ...
                        <path
                          ...
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M930.898 376.736C873.18 342.319 811.307 340.191 792.702 371.393L756.378 432.02C737.761 463.21 769.359 516.15 827.081 550.566C884.804 584.982 946.877 587.903 965.478 556.697L1001.8 496.07C1020.42 464.876 988.625 411.152 930.903 376.736H930.898Z"
                          fill="#333031"
                          stroke="#000000"
                          strokeWidth="18.6064"
                        />
                        <path
                          ...
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M798.477 361.051L765.466 416.997C762.411 417.116 759.115 416.519 756.26 416.879C737.483 419.178 722.946 426.343 715.095 438.171C694.138 469.712 729.947 523.518 795.14 558.449C852.169 589.01 912.829 595.022 941.102 574.889C926.181 579.75 906.469 579.031 885.282 574.105C885.282 573.93 884.988 573.701 885.282 573.493L921.97 502.058C911.387 499.256 900.318 495.049 889.334 490.086L856.102 560.994L814.354 541.984L850.51 467.666C804.947 433.825 782.013 388.658 798.477 361.026V361.051ZM499.337 471.959C460.293 499.538 426.04 535.645 399.976 579.346C300.321 746.502 354.965 962.587 522.117 1062.26C620.044 1120.65 734.84 1125.36 833.172 1086.21C775.387 1079.25 717.963 1060.89 664.749 1029.16C471.427 913.887 402.104 670.574 499.337 471.942V471.959Z"
                          fill="#000000"
                          fillOpacity="0.48936"
                        />
                        <path
                          ...
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M968.06 631.592C984.763 651.793 994.645 676.241 995.532 699.557C996.419 722.873 988.238 743.149 972.79 755.921C957.341 768.694 935.891 772.917 913.157 767.664C890.423 762.411 868.267 748.111 851.564 727.91C834.862 707.708 824.981 683.259 824.094 659.943C823.207 636.626 831.387 616.353 846.835 603.58C862.283 590.808 883.735 586.582 906.469 591.836C929.203 597.089 951.358 611.39 968.06 631.592Z"
                          fill="#FFFFFF"
                          fillOpacity="0.92021"
                        />
                        <path
                          ...
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M942.734 808.425C952.572 820.325 958.393 834.725 958.915 848.459C959.437 862.193 954.618 874.136 945.518 881.659C936.419 889.182 923.784 891.67 910.393 888.575C897.002 885.481 883.952 877.058 874.113 865.158C864.275 853.259 858.456 838.857 857.933 825.123C857.411 811.389 862.23 799.448 871.329 791.925C880.429 784.401 893.064 781.913 906.455 785.007C919.846 788.102 932.896 796.526 942.734 808.425Z"
                          fill="white"
                          fillOpacity="0.92021"
                        />
                        <path
                          id="imagebot 78"
                          d="M930.902 376.734C873.181 342.322 811.312 340.189 792.703 371.392L756.382 432.02C737.762 463.211 769.362 516.147 827.083 550.564C884.809 584.981 946.88 587.904 965.484 556.697L1001.8 496.069C1020.42 464.877 988.628 411.151 930.907 376.734H930.902Z"
                          stroke="#000000"
                          strokeWidth="24.1646"
                        />
                        {flashVariants === bombFlashVariant1 && (
                          <motion.path
                            variants={bombFlashVariant1}
                            initial="initial"
                            animate="animate"
                            id="bomb red state"
                            fillRule="evenodd"
                        ...
                        {flashVariants === bombFlashVariant2 && (
                          <motion.path
                            variants={bombFlashVariant2}
                            initial="initial"
                            animate="animate"
                            id="bomb red state"
                            fillRule="evenodd"
                        ...
                        {flashVariants === bombFlashVariant3 && (
                          <motion.path
                            variants={bombFlashVariant3}
                            initial="initial"
                            animate="animate"
                            id="bomb red state"
                            fillRule="evenodd"
                        ...
                        {flashVariants === bombFlashVariant4 && (
                          <motion.path
                            variants={bombFlashVariant4}
                            initial="initial"
                            animate="animate"
                            id="bomb red state"
                            fillRule="evenodd"
                      ...
                      <g id="wick">
                        ...
                        <path
                          id="imagebot 76"
                          d="M897.119 365.911C895.975 416.352 919.356 445.434 933.804 448.452"
                          stroke="#000000"
                          strokeOpacity="0.68617"
                          strokeWidth="9.31727"
                          strokeLinecap="round"
                        />
                        <path
                          id="imagebot 75"
                          d="M940.62 327.762C932.948 377.626 952.362 409.498 966.299 414.362"
                          stroke="#000000"
                          strokeOpacity="0.68617"
                          strokeWidth="9.31727"
                          strokeLinecap="round"
                        ...
                        <path
                          id="imagebot 74"
                          d="M990.86 292.921C973.709 340.367 986.607 375.384 999.344 382.846"
                          stroke="#000000"
                          strokeOpacity="0.68617"
                          strokeWidth="9.31727"
                          strokeLinecap="round"
                        ...
                        <path
                          id="imagebot 73"
                          d="M1045.63 273.519C1019.9 316.913 1026.01 353.727 1037.1 363.441"
                          stroke="#000000"
                          strokeOpacity="0.68617"
                          strokeWidth="9.31727"
                          strokeLinecap="round"
                      ...
                      {showFuse && (
                        <motion.g animate={bombFuseVariant1} id="spark">
                          <path
                            id="imagebot 9"
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M1050.56 533.684L1107 390.676L1041.75 434.573L1113.19 339.017L1019.33 347.676L1101.88 304.458L848.496 246.168L1077.67 255.094L1002.46 164.729L1126.41 227.896L1108.59 148.857L1158.7 213.196L1155.01 25.5643L1196.09 209.895L1233.34 129.444L1237.04 208.293L1309.52 165.274L1256.64 249.744L1423.66 205.836L1274.18 287.447L1362.02 316.699L1313.23 331.915L1397.59 390.782L1246.76 357.745L1307.49 483.255L1224.53 410.469L1204.62 616.027L1173.77 378.87L1050.56 533.684Z"
                            fill="#AA0000"
                            stroke="#800000"
                            strokeWidth="5.22065"
                          />
