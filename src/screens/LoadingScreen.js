...
const LoadingScreen = ({ screenHeight, screenWidth }) => {
  return (
    <>
      <div style={styles.container}>
        <div>
          <motion.svg
            style={{ width: screenHeight > screenWidth ? "100vw" : "70vw" }}
            initial={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            ...
            <defs>
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stop-color="#FA3663" />
                <stop offset="1" stop-color="#FA3663" stopOpacity="0.09" />
              </linearGradient>
              <linearGradient
                id="paint2_linear"
                x1="745.5"
              ...
              >
                ...
                <stop offset="1" stop-color="#FF6CA5" stopOpacity="0.1" />
              </linearGradient>
              <linearGradient
                id="paint3_linear"
                x1="760"
              ...
              >
                <stop stop-color="#FA3663" />
                <stop offset="1" stop-color="#FA3663" stopOpacity="0.21" />
              </linearGradient>
              <linearGradient
                id="paint4_linear"
                x1="672.5"
              ...
              >
                <stop stop-color="#FF6CA5" />
                <stop offset="1" stop-color="#FF6CA5" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                id="paint5_linear"
                x1="602"
              ...
              >
                <stop stop-color="#FA3663" />
                <stop offset="1" stop-color="#FA3663" stopOpacity="0.7" />
              </linearGradient>
            </defs>
          </motion.svg>
        </div>
